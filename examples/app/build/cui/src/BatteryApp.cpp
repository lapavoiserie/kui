...
HXLINE(  25)		return  ::cui::mui::VStack_obj::__alloc( HX_CTX ,::Array_obj< ::Dynamic>::__new(3)->init(0,_hx_tmp)->init(1,_hx_tmp2)->init(2, ::cui::mui::Text_obj::__alloc( HX_CTX ,::BatteryApp_obj::supply(battery,level),null())),10);
            	}
...
HXLINE(  76)		::Dynamic battery = ::kui::Kui_obj::instance(::hx::ClassOf< ::battery::platform::macos::Battery >());
