...
HX_DEFINE_STACK_FRAME(_hx_pos_7c0836163b1ec49e_39_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","/usr/local/lib/haxe/std/cpp/_std/haxe/Exception.hx",39,0x2b1198f6)
...
void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_7c0836163b1ec49e_39_new)
